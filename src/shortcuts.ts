 ...
 */
export const getNonSteamGames = async (
  steamPath: string,
  userId: string
): Promise<SteamGame[]> => {
  ...
  if (fs.existsSync(userDataPath)) {
    ...
    try {
      ...
      if (
        parsedData &&
        parsedData.shortcuts &&
        typeof parsedData.shortcuts === "object"
      ) {
        ...
        for (const key in shortcuts) {
          if (Object.prototype.hasOwnProperty.call(shortcuts, key)) {
            ...
            const game: SteamGame = {
              ...
              cmd: shortcutInfo.Exe
                ? `file://${shortcutInfo.Exe}`
                : "steam://run/unknown",
              ...
              hidden: shortcutInfo.hidden
                ...
                ? shortcutInfo.IsHidden === "1" ||
                  shortcutInfo.IsHidden === "true"
                : false,
